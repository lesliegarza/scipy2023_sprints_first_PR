...
def angle_to_hexadecimal(angle_in_degrees, decimals=3):
    """
    Convert the given angle to a hexadecimal string of hours of RA.
    ...
    -------
    hms_str : str
        The hexadecimal string giving the hours, minutes, and seconds of RA for
